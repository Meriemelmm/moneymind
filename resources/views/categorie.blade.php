                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="mt-10">
                        ...
                        <div class="flex items-center space-x-4">
                            <input type="text" id="categoryInput" class="border border-gray-300 rounded-md p-2 w-full" placeholder="Ajouter une nouvelle catégorie">
                            <button class="bg-custom text-white rounded-md px-4 py-2" onclick="addCategory()">Ajouter</button>
                        </div>
                        ...
                        <div class="mt-8 overflow-hidden shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">jhzerbh</td>
